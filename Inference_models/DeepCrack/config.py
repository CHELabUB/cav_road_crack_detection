...
class Config:
    ...
    # path
    train_data_path = 'data/CrackTree260/train.txt'
    test_data_path = 'data/Stone331/test.txt'
    checkpoint_path = 'checkpoints'
    log_path = 'log'
    # saver_path = os.path.join(checkpoint_path, name)
    # Just save the path itself
    saver_path = checkpoint_path
    max_save = 20
